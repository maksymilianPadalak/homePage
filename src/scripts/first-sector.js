...
gsap.to('.first-sector-text-wrapper h1', {
  scrollTrigger: { trigger: ".first-sector-text-wrapper h1", toggleActions: "play none none none"}, x: 0})
...
gsap.to('.first-sector-requirements-wrapper', {
  scrollTrigger: { trigger: ".first-sector-description-wrapper", start: "top center", toggleActions: "play none none none"}, x: 0})